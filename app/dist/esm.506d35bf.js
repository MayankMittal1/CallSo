...
})({"2362K":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var Salmon = /** @class */ function(_super) {
    __extends(Salmon1, _super);
    function Salmon1(config) {
    ...
    Object.defineProperty(Salmon1.prototype, "publicKey", {
        get: function() {
            var _a;
    ...
    Object.defineProperty(Salmon1.prototype, "isConnected", {
        get: function() {
            var _a;
    ...
    Object.defineProperty(Salmon1.prototype, "connected", {
        get: function() {
    ...
    Object.defineProperty(Salmon1.prototype, "autoApprove", {
        get: function() {
            return false;
        },
        enumerable: false,
    ...
    Salmon1.prototype.connect = function() {
            ...
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
                        ...
                        this._adapterInstance = new _adapterDefault.default(this._provider, this._network);
    ...
    Salmon1.prototype.disconnect = function() {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
    ...
    Salmon1.prototype.signTransaction = function(transaction) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
    ...
    Salmon1.prototype.signAllTransactions = function(transactions) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
    ...
    Salmon1.prototype.signMessage = function(data, display) {
    ...
    Salmon1.prototype.sign = function(data, display) {
        if (display === void 0) display = 'utf8';
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch(_a.label){
...
},{"eventemitter3":"3fnfh","./adapter":"eqfpC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eqfpC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _eventemitter3 = require("eventemitter3");
var _eventemitter3Default = parcelHelpers.interopDefault(_eventemitter3);
...
var WalletAdapter = /** @class */ function(_super) {
    ...
    // @ts-ignore
    function WalletAdapter1(provider, network) {
        var _this = _super.call(this) || this;
    ...
    Object.defineProperty(WalletAdapter1.prototype, "publicKey", {
        get: function() {
    ...
    Object.defineProperty(WalletAdapter1.prototype, "connected", {
        get: function() {
    ...
    WalletAdapter1.prototype.connect = function() {
        return __awaiter(this, void 0, void 0, function() {
            var _this = this;
    ...
    WalletAdapter1.prototype.disconnect = function() {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
    ...
    WalletAdapter1.prototype.signTransaction = function(transaction) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
    ...
    WalletAdapter1.prototype.signAllTransactions = function(transactions) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
    ...
    WalletAdapter1.prototype.signMessage = function(data, display) {
...
},{"eventemitter3":"3fnfh","@project-serum/sol-wallet-adapter":"4wVuB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2362K"], null, "parcelRequire1c8f")
